...
function handleNewMessage(message) {
    ...
    let file_message = `[${now}] ${username}: ${message.text}\n`;
    let file_name = `./logs/slack-${message.channel}-messages.txt`
    fs.appendFile(file_name, file_message, (err) => { if (err) throw err });
